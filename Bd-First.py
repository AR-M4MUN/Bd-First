...
# Embedded file name: /storage/emulated/0/Bd-First.py
...
print
print
print("Bd Old Facebook Hacking Tool")
print("This tool is free by A R Mamun")
print
psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT.... THIS TOOL MAKE BY A R MAMUN. ANY ONE  CAN USE THIS CODE!')
...
def menu():
    ...
    print 50* '-'
    print 'Codder.  : A R MaMuN'
    print 'AUTHOR   : A R MAMUN'
    print 'FACEBOOK : https://www.facebook.com/AR.M4MUN'
    print 'GITHUB   : https://github.com/AR-M4MUN'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[MAMUN-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Successful]\x1b[0m \n'
